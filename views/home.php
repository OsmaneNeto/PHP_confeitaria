...
<main class="container">
    <h1 class="titulo">🍰 Sistema de Gestão da Doceria</h1>
    <p class="descricao">Bem-vinda ao seu painel de controle! Escolha uma das opções abaixo:</p>
    ...
    <div class="botoes-menu">
        ...
        <a href="gerenciar_encomendas.php" class="btn">📋 Gerenciar Encomendas</a>
